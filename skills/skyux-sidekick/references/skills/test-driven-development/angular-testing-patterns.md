...
export class SkyExampleHarness extends SkyComponentHarness {
  ...
  public static with(filters: SkyExampleHarnessFilters): HarnessPredicate<SkyExampleHarness> {
...
const highlightEl = fixture.debugElement.query(By.directive(HighlightDirective));
