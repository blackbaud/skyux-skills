...
source: ./selection-modal.md
section_count: 21

---

# Section index — selection-modal

Tabs mirror the SPA navigation: `design` (purpose / when-to-use / anatomy / options), `development` (install + API surface), `testing` (harnesses), `examples` (code examples — use the sibling `examples-index.md` for finer detail).
...
| --- | ------------------------------------------- | ----------- | -------- | ---------------------------------------------------------- |
| 1   | Usage                                       | design      | 10–49    | `Read file_path=./selection-modal.md offset=10 limit=40`   |
| 2   | Anatomy                                     | design      | 50–77    | `Read file_path=./selection-modal.md offset=50 limit=28`   |
| 3   | Options                                     | design      | 78–91    | `Read file_path=./selection-modal.md offset=78 limit=14`   |
