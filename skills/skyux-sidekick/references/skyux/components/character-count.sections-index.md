...
source: ./character-count.md
section_count: 13

---

# Section index — character-count
...
| --- | ------------------------------------------ | ----------- | ------- | --------------------------------------------------------- |
| 1   | Usage                                      | design      | 10–33   | `Read file_path=./character-count.md offset=10 limit=24`  |
| 2   | Anatomy                                    | design      | 34–49   | `Read file_path=./character-count.md offset=34 limit=16`  |
| 3   | Options                                    | design      | 50–55   | `Read file_path=./character-count.md offset=50 limit=6`   |
