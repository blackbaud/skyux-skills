...
| --- | ------------------------------------------------- | ----------- | --------- | --------------------------------------------------- |
| 1   | Usage                                             | design      | 10–63     | `Read file_path=./lookup.md offset=10 limit=54`     |
| 2   | Anatomy                                           | design      | 64–111    | `Read file_path=./lookup.md offset=64 limit=48`     |
| 3   | Options                                           | design      | 112–165   | `Read file_path=./lookup.md offset=112 limit=54`    |
