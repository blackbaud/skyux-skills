...
source: ./angular-tree.md
section_count: 10

---

# Section index — angular-tree
...
| --- | ------------------------------ | ----------- | ------- | ------------------------------------------------------- |
| 1   | Usage                          | design      | 10–19   | `Read file_path=./angular-tree.md offset=10 limit=10`   |
| 2   | Anatomy                        | design      | 20–43   | `Read file_path=./angular-tree.md offset=20 limit=24`   |
