...
81 of 95 components have a `## Code Examples` section in their source docs.

## Components with code examples

| Component                    | Examples | Index                                                                                              |
| ---------------------------- | -------- | -------------------------------------------------------------------------------------------------- |
| action-button                | 2        | [action-button.examples-index.md](./action-button.examples-index.md)                               |
| action-hub                   | 1        | [action-hub.examples-index.md](./action-hub.examples-index.md)                                     |
| alert                        | 1        | [alert.examples-index.md](./alert.examples-index.md)                                               |
| angular-tree                 | 3        | [angular-tree.examples-index.md](./angular-tree.examples-index.md)                                 |
| autocomplete                 | 5        | [autocomplete.examples-index.md](./autocomplete.examples-index.md)                                 |
| autonumeric                  | 4        | [autonumeric.examples-index.md](./autonumeric.examples-index.md)                                   |
| avatar                       | 1        | [avatar.examples-index.md](./avatar.examples-index.md)                                             |
...
| error                        | 2        | [error.examples-index.md](./error.examples-index.md)                                               |
| field-group                  | 2        | [field-group.examples-index.md](./field-group.examples-index.md)                                   |
| file-attachment              | 2        | [file-attachment.examples-index.md](./file-attachment.examples-index.md)                           |
...
| icon                         | 2        | [icon.examples-index.md](./icon.examples-index.md)                                                 |
| id                           | 1        | [id.examples-index.md](./id.examples-index.md)                                                     |
| illustration                 | 1        | [illustration.examples-index.md](./illustration.examples-index.md)                                 |
...
| lookup                       | 5        | [lookup.examples-index.md](./lookup.examples-index.md)                                             |
| media-query                  | 2        | [media-query.examples-index.md](./media-query.examples-index.md)                                   |
| modal                        | 5        | [modal.examples-index.md](./modal.examples-index.md)                                               |
...
| search                       | 1        | [search.examples-index.md](./search.examples-index.md)                                             |
| sectioned-form               | 1        | [sectioned-form.examples-index.md](./sectioned-form.examples-index.md)                             |
| selection-box                | 2        | [selection-box.examples-index.md](./selection-box.examples-index.md)                               |
| selection-modal              | 2        | [selection-modal.examples-index.md](./selection-modal.examples-index.md)                           |
| sort                         | 1        | [sort.examples-index.md](./sort.examples-index.md)                                                 |
| split-view                   | 3        | [split-view.examples-index.md](./split-view.examples-index.md)                                     |
...
| text-highlight               | 1        | [text-highlight.examples-index.md](./text-highlight.examples-index.md)                             |
| tile                         | 1        | [tile.examples-index.md](./tile.examples-index.md)                                                 |
| timepicker                   | 1        | [timepicker.examples-index.md](./timepicker.examples-index.md)                                     |
| toast                        | 2        | [toast.examples-index.md](./toast.examples-index.md)                                               |
| toggle-switch                | 2        | [toggle-switch.examples-index.md](./toggle-switch.examples-index.md)                               |
